    ...
    <div id="box">
        <div class="inner layout herd">
            <div class="fs18px v100 flex-be sty">
                ...
                <img :src="minedata.avatar" alt="" class="imgurl">
            </div>
        </div>
        <div class="line">
            <div class="inner layout">
                <div v-if="minedata.phone" class="fs18px v100 flex-be sty">
            ...
            <div class="inner layout">
                ...
                <div v-else class="fs18px v100 flex-be sty" @click="popupVisible=true">
                    <span class="posi">现居城市</span>
                    <p class="rightSty">{{address || '未设置'}} </p>
                    <img src="https://chuang-saas.oss-cn-hangzhou.aliyuncs.com/icon/dongyao/goright.png" alt="" class="imgrigth">
                </div>
            </div>
            <x-address style="display:none;" :title='title' :hide-district='true' @on-shadow-change="onShadowChange" v-model="nowAddress.nowAddressArr" :list="VUXaddressData" :show.sync="popupVisible" :raw-value="true" @on-hide='dada'></x-address>
            <div class="inner layout">

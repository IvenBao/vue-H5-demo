<template>
  <div class="big">
    ...
    <opera-tion :productId="productId" :productData="productData" v-on:iSshow="iSshow"></opera-tion>
  </div>
</template>
<script>
...
export default {
  ...
  mounted() {
    ...
    this.productId.themeId = Number(params.productId)
    if (this.productId.themeId > 0) {

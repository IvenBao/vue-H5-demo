<template>
  <div class="big">
    ...
    <opera-tion :productId="productId" :price="productData.priceDesc" v-on:iSshow="iSshow"></opera-tion>
    <adv-isory v-show="isShow" v-on:noshow="noshow"></adv-isory>
  </div>
</template>
<script>
// import { getOfflineActivityThemeDetailByThemeId } from '@/api'
import operaTion from '@/views/offline-detail/operation.vue'
import conTent from '@/views/offline-detail/content.vue'
import advIsory from '@/views/offline-detail/advisory.vue'
...
export default {
  data() {
    return {
      ...
      productData: {
        themeHrefUrl: 'http://1254016570.vod2.myqcloud.com/7176c53evodgzp1254016570/822fe01c5285890780717738819/fU4oyY5EooQA.mp4',
        // themeHrefUrl: 'http://chuang-saas.oss-cn-hangzhou.aliyuncs.com/upload/image/20180911/ee26846833ab481d8b0815d1f5def3d7.jpeg',
        themeType: 1,
        // themeType: 0,
        themeName: 'TALENT CULTIV',
        activityTime: '3天2夜',
        ...
        contentText: '非常有效、百试不爽的快速卖货的大大撒打算打算第三代',
        money: 1980,
        person: 1000
      },
      isShow: false
  ...
  mounted() {
    ...
    //     getOfflineActivityThemeDetailByThemeId(this.productId).then(res => {
    //         // res.data.price = 100;
    //         this.productData = res.data;
    //         if (res.data.phone) {
    //             this.productId.phone = res.data.phone;
    //         } else {
    //             this.productId.phone = '0579-83443200';
    //         }
    //         // this.productId.phone = res.data.phone;

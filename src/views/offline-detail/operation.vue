<template>
  <div>
    <div class='footer flex-ar' v-if="productData.isfree == 0">
      <div class='share' @click="onPhone">
        <img src="http://chuang-saas.oss-cn-hangzhou.aliyuncs.com/upload/image/20181122/d43cc96008d04f34aa3c680573956960.png" alt="">
        <span>咨询</span>
      </div>
      <div class='buy' @click='signUp'>
        <span style="margin-left:10px;">立即报名</span>
      </div>
    </div>
    <div class='footer flex-ar' v-else-if="productData.isfree == 1">
      <div class='share' @click="onPhone">
        <img src="http://chuang-saas.oss-cn-hangzhou.aliyuncs.com/upload/image/20181122/d43cc96008d04f34aa3c680573956960.png" alt="">
        <span>咨询</span>
      </div>
    ...
    <div class='footer flex-ar' v-else-if="productData.isfree == 2">
      <div class='share' @click="onPhone">
        <img src="http://chuang-saas.oss-cn-hangzhou.aliyuncs.com/upload/image/20181122/d43cc96008d04f34aa3c680573956960.png" alt="">
        <span>咨询</span>
      </div>
